...
import type {
  ILeveragedPool2,
  ILeveragedPool2Interface,
} from "../ILeveragedPool2";
...
export class ILeveragedPool2__factory {
  static readonly abi = _abi;
  static createInterface(): ILeveragedPool2Interface {
    return new utils.Interface(_abi) as ILeveragedPool2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ILeveragedPool2 {
    return new Contract(address, _abi, signerOrProvider) as ILeveragedPool2;
  }
}
